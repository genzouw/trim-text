...
実例が Qodo Merge (旧 PR-Agent) です。「公開リポジトリなら無料」という前提で導入されていました。しかし Qodo に恒久的な無料プランは存在しません。公式料金ページの FAQ にも "We don't offer a permanent free tier" と明記されています。結果として、無料トライアルの終了とともに停止しました。2026-09 に撤去済みで、再導入は **MUST NOT** です。
